	...
	{:else}
		<div class="w-1/3 text-dark-text space-y-5">
			...
			<p>
				...
				share your own projects in the browser. The <strong>demo project</strong> should give you an
				idea of the future of the application, allowing you to complete and submit an exercsise.
			</p>
