...
describe('The folder component', () => {
	...
	it('can be deleted', async () => {
		...
		const deleteButton = await screen.findByTestId('delete-folder');
	...
	it('can add child folder', async () => {
		...
		fireEvent.mouseEnter(screen.getByTestId('hoverable'));
		const addFolderButton = await screen.findByTestId('create-child-folder');
	...
	it('can add child file', async () => {
		...
		fireEvent.mouseEnter(screen.getByTestId('hoverable'));
		const addFolderButton = await screen.findByTestId('create-child-file');
		fireEvent.click(addFolderButton);
	...
	it('can be renamed', async () => {
		...
		fireEvent.mouseEnter(screen.getByTestId('hoverable'));
		const renameButton = await screen.findByTestId('rename-folder');
